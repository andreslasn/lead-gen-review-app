export default {
  ...
  template:`
    ...
    <div class="email-title-row">
      ...
      <button v-if="editable" :disabled="disabled" class="edit-email-btn" @click="$emit('edit')" title="Edit email" aria-label="Edit email"><svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M9.9 3.1l3 3M2.5 13.5l3.35-.7 6.7-6.7a2.12 2.12 0 00-3-3l-6.7 6.7-.35 3.7z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/></svg></button>
    </div>`
};
